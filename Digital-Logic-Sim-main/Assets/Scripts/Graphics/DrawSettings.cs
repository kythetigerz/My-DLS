...
namespace DLS.Graphics
{
	public static class DrawSettings
	{
		...
		public const float PinHeight32Bit = 0.69f;
		public const float PinHeight64Bit = 0.82f;
		...
		{
			index = (ulong)Mathf.Min(index, ActiveTheme.StateHighCol.Length - 1); // clamp just to be safe...
